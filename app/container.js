...
container
	...
	.register({
		...
		PlanningController: asClass(PlanningController).singleton(),
	...
	.register({
		...
		PlanningRepository: asClass(PlanningRepository).singleton(),
	...
	.register({
		...
		PlanningDto: asClass(PlanningDto).singleton(),
