...
module.exports = {
	up: async queryInterface => {
		return queryInterface.bulkInsert(
			...
			[
				{
					programs_id: 1,
					test_number: '335964885',
					test_name: 'Test_name Ipsum 1',
					conditions:
				...
				{
					programs_id: 2,
					test_number: '776353253',
					test_name: 'Test_name Ipsum 2',
					conditions:
				...
				{
					programs_id: 3,
					test_number: '903268634',
					test_name: 'Test_name Ipsum 3',
					conditions:
	...
	down: queryInterface => {
		return queryInterface.bulkDelete('test_reports', null, {})
	}
}
